package com.pratham.accounts.controller;
...
import com.pratham.accounts.dto.AccountsContactInfoDto;
import com.pratham.accounts.dto.CustomerDto;
import com.pratham.accounts.dto.ErrorResponseDto;
import com.pratham.accounts.dto.ResponseDto;
...
public class AccountsController {
	...
	@Operation(
            ...
            description = "Get Contact Info Details that can be reached if any issues into Accounts Microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
